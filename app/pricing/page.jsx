...
const TIERS = [
  { key: "free", name: "Free", price: "$0", per: "forever", credits: "5 hunts included", blurb: "See the magic once.", popular: false,
  ...
  { key: "max", name: "Max", price: "$49", per: "/month", credits: "200 hunts / month", blurb: "Land it this month.", popular: false,
  ...
  return (
    <div className="min-h-screen bg-ink">
      ...
      <header className="text-center px-6 pt-16 pb-12">
        ...
        <p className="text-fog max-w-xl mx-auto">One hunt = one company: we find the hiring manager, build your personalized pitch page, render your AI video, and draft the outreach. You just hit send.</p>
      </header>
