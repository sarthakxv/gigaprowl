  ...
  return (
    <div className="min-h-dvh bg-ink">
      ...
      <header className="text-center px-6 pt-16 pb-12">
        ...
        <p className="text-pretty text-fog max-w-xl mx-auto">One hunt is one company. We find the hiring manager, build a pitch page, render an AI video of you, and draft the outreach. You hit send.</p>
      </header>
      ...
      <div className="max-w-5xl mx-auto px-6 pb-20">
        ...
        <p className="text-pretty text-center text-fog/60 text-xs mt-8">Cancel anytime. Unused monthly hunts roll over while subscribed. Videos use your own face and voice, with consent. Delete anytime.</p>
      </div>
    </div>
  );
}
