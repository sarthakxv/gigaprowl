...
## PART 1 — 30 Video Concepts (6 angles × 5)

Naming convention per 03 doc: `[ANGLE]_[FORMAT]_[HOOKCODE]_[actor]_[ratio]_[v]_[date]` — e.g. `RAGE_GS_GHOSTJOB_ARC-F2_916_V1_260715`.

### ANGLE A — Job-Market Rage (shared-enemy content: ATS, ghost jobs, the void)

---

**A1. "Rejected in 0.3 Seconds"**
- **Platform:** TikTok + Reels · **Format:** AI UGC talking head (Arcads) → screen-record splice
- **Script (30s):**
...
**A2. "The Ghost Job Autopsy"**
- **Platform:** TikTok · **Format:** greenscreen rant over screenshot of a real 6-month-old job posting
- **Script (35s):**
...
**A3. "The Audacity Files, Ep. 1"** (serialized comment-bait)
- **Platform:** TikTok + Shorts · **Format:** greenscreen dramatic reading
- **Script (30s):**
...
**A4. "Job Boards Profit When You Stay Unemployed"** (contrarian rage)
- **Platform:** TikTok + Reels · **Format:** AI UGC talking head (Arcads, confident 28yo actor)
- **Script (30s):**
...
**A5. "I Did the Math on 'Just Tailor Your Resume'"** (stitch-adjacent, standalone version)
- **Platform:** TikTok · **Format:** AI UGC talking head + on-screen calculator graphics
- **Script (32s):**
...
- **Sound:** ticking clock → satisfying "ding" at the demo.

---

### ANGLE B — "Marta-as-a-Service" Demo (the flagship product-wow angle)

---

**B1. "The Girl Who Broke LinkedIn — Automated"**
- **Platform:** TikTok + Reels + LinkedIn native · **Format:** greenscreen over Marta Puerto coverage → screen-record demo
- **Script (38s):**
  - HOOK: "One woman made a pitch video and a personal website instead of applying — and got HUNDREDS of interview requests."
  - (3–12s): Greenscreen over the viral post/coverage. "60K likes. 5,000 connection requests. Her free-trial-of-Marta bit ended with 'book an interview.' Legendary. Also: a full week of work."
...
**B2. "He Has No Idea This Video Is AI"** (avatar wow-moment — most viral asset)
- **Platform:** TikTok primary · **Format:** split-screen novelty (real creator + their HeyGen-pipeline avatar)
- **Script (32s):**
...
**B3. "Rate My Job Hunt"** (stat-card demo, endlessly remixable)
- **Platform:** TikTok + Shorts · **Format:** pure screen-recording demo with VO
- **Script (25s):**
  - HOOK: "Rate my job hunt: one upload. Watch."
  - (2–18s): Real-time screen capture with VO play-by-play: "Resume in… 12 matches… it found FOUR hiring managers by name… pitch page… and it's rendering a video of me. I did nothing."
  - (18–23s): Final stat card: "1 upload · 12 matches · 4 managers found · 1 interview booked."
  - CTA: "Your turn. First 5 hunts free."
- **Overlays:** running counter ticking up ("matches: 12 ✓ managers: 4 ✓ video: rendering…")
- **Sound:** speedrun/typing ASMR audio. **Note:** this is the volume workhorse — re-record weekly with different resumes/roles.

---

**B4. "I Sent ONE Application This Week"** (the repeatable bit — reply reveal)
- **Platform:** TikTok + Reels; screenshot version as X thread · **Format:** talking head (real creator or Arcads) + screen record + blurred reply
- **Script (35s):**
  - HOOK: Holding phone up, blurred email visible. "I sent ONE thing this week. The VP replied in four hours."
  - (3–10s): "Everyone else sent 200 applications into the ATS. Generic apps get a 2–3% interview rate. I skipped the line."
...
**B5. "POV: You're the Hiring Manager"** (perspective flip)
- **Platform:** TikTok + Reels; hiring managers reshare on LinkedIn · **Format:** solo sketch, wardrobe change (blazer = manager)
- **Script (38s):**
...
### ANGLE C — POV Memes (low-effort, high-volume, faceless-friendly)
...
**C5. "POV: Day 47 of Unemployment"** (ironic grindset, serialized)
- **Platform:** TikTok + Reels · **Format:** vlog with deadpan VO (real creator; brief micro-creators on this one)
- **Script (35s):**
...
- **Sound:** lo-fi "productive morning" vlog audio, played straight.

---

### ANGLE D — Receipts / Stats (proof-first, screenshot-heavy)
...
- **Script (40s):**
  ...
  - CTA: "Run your own experiment — 5 hunts free."
- **Overlays:** "150 apps → 2 replies (1.3%)" · "10 pitches → 6 replies (60%)" · "SAME RESUME"
- **Sound:** minimal — keyboard ASMR + VO. **Guardrail:** run this with real beta users; keep raw footage as substantiation.
...
**D3. "Auto-Apply Bots: The Trustpilot Horror Show"** (anti-LazyApply positioning)
- **Platform:** TikTok; X thread version with receipts · **Format:** greenscreen over review screenshots
- **Script (38s):**
...
**D4. "6 Seconds vs 30 Seconds"**
- **Platform:** TikTok + Reels · **Format:** AI UGC talking head (Creatify) + timer graphics
- **Script (28s):**
...
- **Script (30s):**
  ...
  - (18–26s): Summary card: "22 hunts · 17 opened · 8 replies · 3 interviews."
  - CTA: "Track replies, not rejections. First 5 hunts free."
- **Overlays:** live status flips · "replies > rejections" end card
- **Sound:** soft satisfying UI-click foley.

---

### ANGLE E — Duet-Bait / Stitch-Bait (built to be responded to, and to respond)

---

**E1. "Stitch This: 'Just Tailor Your Resume!'"** (the stitch)
- **Platform:** TikTok (stitch), Reels (remix) · **Format:** stitch a recruiter/career-coach clip → deadpan cut
- **Script (30s):**
...
**E2. "Duet Me Your Rejection Wall"** (the bait — invites duets IN)
- **Platform:** TikTok · **Format:** creator on one side of a pre-split frame, empty side labeled "your rejection wall here"
- **Script (25s):**
...
**E3. "Reply to This Comment" Series** (comment-reply video engine)
- **Platform:** TikTok · **Format:** video reply to a pinned comment ("what's your job title? I'll run a hunt")
- **Script (25s per episode):**
  - HOOK: Comment on screen: "'marketing coordinator, Chicago, 3 yrs exp' — okay, hunting."
  - (3–18s): Live-ish screen record: matches for that profile → a real company (blur specifics) → hiring manager found → pitch page skeleton.
  - (18–23s): "That took 58 seconds. Imagine it with YOUR resume."
  - CTA: "Drop your title + city below for the next episode."
- **Overlays:** the comment pinned top · running timer
- **Sound:** game-show thinking music. **Note:** infinite episodes, every episode manufactures the next one's comments.

---

**E4. "Stitch This: 'It's All About Networking'"**
- **Platform:** TikTok · **Format:** stitch any "just network!" advice clip
- **Script (30s):**
...
**E5. "Green Flag / Red Flag: Job Posting Edition"** (duet-format game)
- **Platform:** TikTok + Shorts · **Format:** rapid-fire judging game, greenscreen over postings
- **Script (30s):**
...
### ANGLE F — Transformation Stories (before/after, testimonial energy)

---

**F1. "Laid Off in March. Hired in May."**
- **Platform:** TikTok + Reels + LinkedIn · **Format:** AI UGC talking head (Arcads, warm 30s actor) — graduate to real user testimonial ASAP
- **Script (35s):**
  - HOOK: "Laid off in March. Hired in May. This is the tool, and this is exactly what happened."
  - (3–12s): "March: panic-applied to 90 jobs. Two automated rejections, 88 nothing. April: changed the strategy."
  - (12–26s): "Uploaded my resume once. It found roles I'd never have searched, found the hiring managers, and pitched them a video of me." Quick demo beats.
  - (26–32s): "Three conversations in two weeks. One became an offer."
  - CTA: "If you got cut this year — 5 hunts free. Start tonight."
- **Overlays:** "MARCH: laid off" · "90 apps → 0 humans" · "MAY: signed offer"
- **Sound:** quiet piano → warm resolve. **Guardrail:** run as clearly illustrative until a real user story replaces it; never invent named employers.

---

**F2. "New Grad, 0 Connections, 4 Interviews"**
- **Platform:** TikTok + Shorts · **Format:** UGC talking head → screen demo splice (young creator)
- **Script (32s):**
  - HOOK: "I graduated with zero connections, zero referrals, and a resume with one internship. Four interviews anyway. Here's how."
  - (3–12s): "Every posting I liked had 800 applicants. The referral kids won every time. So I manufactured the referral effect."
  - (12–24s): Demo: match → manager's name → "a pitch page and a video of me went straight to her."
  - (24–29s): "Turns out 'connections' just means the manager knows your face. Now they know mine."
  - CTA: "Manufacture your referral. Link in bio."
- **Overlays:** "0 connections" · "800 applicants/posting" · "4 interviews"
- **Sound:** underdog hopecore trend audio.

---

**F3. "Unemployed → Employed Speedrun (Real)"**
- **Platform:** TikTok · **Format:** speedrun-style edit, screen-record heavy, timestamp overlays
- **Script (28s):**
  - HOOK: "Unemployed to employed speedrun. Any%. Timer starts now."
  - (2–20s): Rapid cuts with timestamps: "0:00 resume upload… 0:41 twelve matches… 1:15 hiring managers named… 2:03 my AI video rendered… day 2: opened… day 3: reply… day 9: interview… day 21: OFFER."
  - (20–25s): Timer slams stop. "New personal best."
  - CTA: "Run your own speedrun — first 5 hunts free."
- **Overlays:** speedrun timer UI throughout · "NEW PB: 21 days"
- **Sound:** speedrun/gaming music, splice-heavy editing.

---

**F4. "My Career Change Nobody Believed In"**
- **Platform:** TikTok + Reels · **Format:** AI UGC talking head (Creatify, mid-career actor)
- **Script (35s):**
...
- **Script (33s):**
  ...
  - CTA: "Start your week 1 — it's free."
- **Overlays:** "WEEK 1: skeptical" · "WEEK 4: 2 interviews" · "same me, different door"
- **Sound:** time-lapse/journey trend audio. **Note:** recruit 3–5 beta users to run this publicly = UGC flywheel from playbook §6.

---

## PART 2 — 10 Static / Carousel Ad Concepts (Meta)
...
### 12 Tweets / Thread Starters (post as-is from founder account)
...
12. "we watch users hit the 'found your hiring manager' screen in real time and the session recordings all do the same thing: scroll stops for 4 full seconds. that pause is the product."
...
**L2 — Contrarian take:**
"Hiring managers: the 'application volume crisis' is not a candidate-quality problem. It's a doorway problem.
You put one door on the building (the ATS), 600 people lined up at it, and now everyone's mad that the line is long and the door is a shredder.
The best candidate for your role probably applied. Your system rejected them in 0.3 seconds over a keyword. The fix isn't AI screening the pile faster. It's letting candidates show up as humans — face, story, specifics — before the pile.
Disagree? Tell me why in the comments. Genuinely asking."
...
**L5 — Contrarian job-market take #2:**
"'Tailor every application' is mathematically illiterate advice.
400 applications × 30 minutes of tailoring = 200 hours. Five unpaid work weeks. Nobody does it — so everyone sends generic apps, which convert at 2–3%, which forces more volume, which makes tailoring even less feasible. It's a doom loop with a spreadsheet.
...
## PART 4 — Naming / Branding Mini-Section
...
### 5.1 Tool routing (which concepts go where)

**Arcads (~$110/mo, highest-realism AI actors — use for face-led persuasion):**
- A1, A4, A5, D4, F1, F4 (talking-head-heavy, emotion-led)
- Batch rule: same script × 3 different actors = 3 ads (faces fatigue independently, per 03 §3.2)
...
**CapCut templates (free — human-shot + faceless volume):**
- All slideshows (C1, C2, C3, D2) — build 3 reusable slide templates, refill text weekly
- Greenscreen concepts (A2, A3, D3, E5) — one greenscreen preset, swap screenshots
- Speedrun edit (F3), split-screen (C4), stitches (E1, E4) — one template each
- Screen-record demos (B3, D1, D5) need no generation at all: raw capture + CapCut captions

**Real humans required (don't fake these):** B4's reply reveal, C5/F5 diary vlogs (micro-creators, $50–200 + referral code), E2 duet bait, D1 experiment (beta users). Graduate F1/F2 from AI to real testimonials as soon as real users exist.

### 5.2 Hook A/B matrix — 3 hooks per top-5 concept (15 launch ads)

| Concept | Hook 1 (pain) | Hook 2 (curiosity) | Hook 3 (contrarian/proof) |
|---|---|---|---|
| **B4** One Application | "I applied to 300 jobs and got 2 interviews. Then I stopped applying." | "I sent ONE thing this week. The VP replied in 4 hours." | "Applying to 1,000 jobs is cosplay. Getting 1 reply is a career." |
| **B2** AI Clone | "Nobody reads your resume. They watch this instead." | "One of these is not me." | "I made an AI clone of myself and it's better at job hunting than me." |
| **B3** Rate My Hunt | "Month 4 of the search and Indeed ghosted me again. So — watch this." | "Rate my job hunt: one upload. Watch." | "This took 60 seconds. Your last application took 45 minutes." |
| **A1** 0.3 Seconds | "A robot rejected my resume in 0.3 seconds." | "Want to know how fast the ATS rejected you? I timed it." | "The ATS rejected you in 0.3 seconds. This took 30." |
| **C3** Slideshow | "how applying to jobs in 2026 feels" | "the 6 stages of applying in 2026 (stage 5 hurts)" | "250 people applied to that job. here's what the 1 who got it did" |

Testing rules (from 03 §3.3): one variable per test · Meta kill at $15 spend/0 signups or hook rate <25% · TikTok kill at 2,500 imprs with CTR <0.8% · winners duplicated to scale campaign, never edited · decision order: hook rate → CTR → CPSignup.
...
|---|---|---|---|
| **W1 Mon** | B3 Rate My Hunt v1 · B2 AI Clone | C3 slideshow v1 | C5 Day 47 |
| **W1 Tue** | B4 One Application · Hunt of the Day #1 | A3 Audacity Ep.1 · C1 slideshow | F5 Week-1 diary intro |
| **W1 Wed** | D1 Experiment pt.1 · Hunt of the Day #2 | C4 portal-vs-person · C3 remix | C5 Day 48 |
...
### 5.4 Compliance guardrails (apply to every asset)
- Real reply screenshots only, names/companies blurred; keep raw substantiation for any stat/result claim.
- Illustrative testimonials (F1/F4 via AI actors) must not name real employers; swap to real user stories with written permission ASAP.
- Provocation yes ("resumes are dead"), deception framing no — the Cluely lesson from the playbook.
- Meta employment-ads note: career-related ads can trigger Special Ad Category review — keep targeting broad (already the plan) and avoid "guaranteed job" claims in copy.
