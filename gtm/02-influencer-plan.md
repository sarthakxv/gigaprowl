...
**Product hook for creators:** "Upload your resume → AI finds matching jobs AND the hiring managers → generates a personalized pitch page + AI avatar video." This is inherently demo-able, screen-recordable, reaction-friendly content — perfect for CareerTok formats.

> Follower counts are approximate, pulled from public lists/profiles (Feedspot Career TikTok ranking, Welcome to the Jungle CareerTok list, Extern's influencer roundup, Favikon, LinkedIn Top Voices) as of mid-2026. Re-verify each count at outreach time — creator counts drift fast.

---

## 1. Target Creator List (44 creators)
...
| 32 | Mingke — @mingkecareer | TikTok | ~11K | Helps non-native English speakers land jobs | Global-English + India/intl segment; pitch pages help non-natives write better | "Let AI write the pitch your English professor would envy" |

### B. Instagram Reels

| # | Creator / Handle | Platform | ~Followers | Content style | Why they fit | Collab angle |
|---|---|---|---|---|---|---|
...
| # | Creator / Channel | Platform | ~Size | Content style | Why they fit | Collab angle |
|---|---|---|---|---|---|---|
| 38 | Jeff H. Sipe — Practice Interviews | YouTube | ~53K subs | Ex-Google interview coach; calm, tactical | Tech interview audience, high trust | Pre-roll integration: "get the interview first" |
| 39 | Ben Talks Talent (Ben White) | YouTube + Shorts | ~30–60K (verify) | Recruiter POV interview advice | Recruiter authenticity | Dedicated review video + Shorts cutdowns |
| 40 | Stacey Davidson — Cultivate Your Career | YouTube | ~10K subs | Certified career-development pro | Nano YT = cheap dedicated reviews | Full walkthrough video (evergreen SEO value) |
| 41 | Madeline Mann — Self Made Millennial | YouTube + TikTok | ~363K subs | Punchy, structured job-search frameworks | Category queen; stretch/reach tier | Sponsored segment in a "job search in 2026" video |

### D. LinkedIn + Twitter/X

| # | Creator | Platform | ~Size | Content style | Why they fit | Collab angle |
|---|---|---|---|---|---|---|
| 42 | Joel Lalgee — The Realest Recruiter | LinkedIn + TikTok | 500K+ LI (reach tier) | Recruiter humor + hot takes | Massive job-seeker reach; sets narrative among recruiters | Meme/skit + honest take; whitelisted LinkedIn post |
| 43 | Emily Liou | LinkedIn | ~100K+ (verify) | Career happiness coach, LinkedIn Top Voice (Job Search) | LinkedIn-native job seekers | Carousel post: "I tested an AI that pitches you to hiring managers" |
| 44 | Hannah Morgan — @careersherpa | Twitter/X + LinkedIn | ~50K X (verify) | Job-search visibility strategist, curator | X/newsletter distribution to serious searchers | Sponsored newsletter + X thread review |

### E. India-focused bench (verify counts before outreach)

| Creator | Platform | ~Size | Why |
|---|---|---|---|
| Diksha Arora — Interview Coach | IG + YouTube | ~2M IG / 1.2M YT (mega — reach tier, not seeding tier) | India's biggest interview-prep voice; save for a later paid flight |
| Shreyaa Kapoor | LinkedIn + IG | ~500K+ (reach) | Ex-Bain, early-career productivity/finance; LinkedIn Top Voice Next Gen |
| Nidhi Nagori | TikTok/IG | ~395K | "Move abroad" jobs content — Indian diaspora + global English |
| Mehar — MSB Vision | IG + LinkedIn | micro (verify) | Career enhancer, 5,000+ students mentored, campus reach |
| Priya Yadav | IG | micro (verify) | Job search, CV, interview tips in Hindi/English mix — fresher audience |
| Nav Karmacharya | TikTok/IG | ~14K+ | Cybersecurity day-in-the-life; Gen Z tech audience (featured in Fortune) |

**Note on India:** TikTok is banned in India — run India seeding on Instagram Reels, YouTube Shorts, and LinkedIn only. Micro-influencer rates in India are typically 30–60% below US rates, so the same budget buys 2–3x the volume.

---

## 2. Tiering — First 10 to Hit and Why

**Wave 1 (Weeks 1–3): 10 creators, optimized for trust + demo-ability + cost**
...
**Logic:** 4 recruiter/HR-credibility voices (2, 3, 5, 9), 3 cheap nano experiments across segments (1, 6, 7), 2 audience-niche bets (4, 8), 1 international test (10). Cap Wave 1 spend at ~$3–4K. Measure installs per creator, then double down on the 3 best-performing archetypes in Wave 2 (creators 11–30 of the list).

**Wave 2 (Weeks 4–8):** Scale the winning archetype across 15–20 more creators from the list; add India bench via IG/Shorts.
**Wave 3 (Weeks 9–12):** 1–2 reach-tier bets (Sam DeMase, Joel Lalgee, or Madeline Mann) + whitelist the best Wave 1–2 clips as paid ads.

---

## 3. Outreach + Incentive Structure
...
>
> - 1 short video (your style, your script — honest take welcome)
> - $[X] flat + $[Y] per install via your link, no cap
> - Free Pro for you + 50 codes for your followers
>
> If you'd rather just try it first, here's a Pro account: [link]. No strings.
>
> [You] — [phone/site]

**Rules:** reference one specific video (proves it's not spray-and-pray); lead with the product's weirdness (AI avatar video = hook); always offer "honest review welcome" — career audiences smell shills; keep first touch under 100 words.

### 2025–2026 micro-influencer compensation benchmarks (from current pricing guides)

| Model | Market rate | Notes |
|---|---|---|
| Flat fee per TikTok video (10–100K followers) | $200–$800 (many nano deals close at $100–$300) | Instagram Reels ~10–20% higher; YouTube dedicated videos 2–4x |
| Affiliate / rev-share | 10–20% of first-year revenue, or $1–3 per qualified install/signup | Give unique codes + UTM links |
| Free Pro account ("product seeding") | $0 cash | Works for nano (<25K) and warm fans; ~10–20% post organically |
| UGC licensing (paid usage rights) | +20–50% of base rate, 30/60/90-day license | 90-day commands the premium |
...
| Rung | Who | Offer |
|---|---|---|
| L0 — Seed | Nano (<25K) + any warm fan | Free Pro (12 mo) + 25–50 giveaway codes for their audience. No posting obligation, just "tell us what you think" |
...
## 4. Influencer Ops Process

### Tracking sheet columns (Google Sheet / Airtable)

`Creator name | Handle | Platform(s) | Follower count (date checked) | Avg views (last 10 posts) | Engagement % | Niche/archetype (recruiter POV / layoff / new-grad / tech / India) | Email/DM channel | Agent? | Status (Not contacted → DM'd → Replied → Negotiating → Contracted → Briefed → Posted → Paid) | Offer rung (L0–L4) | Agreed fee | Affiliate code | UTM link | Post URL | Post date | Views | Likes | Comments | Link clicks | Installs | Signups | Cost per install | Usage rights (none / organic 30d / paid 90d / whitelist) | Rights expiry date | Spark Ads code received? | Contract link | W-9/W-8BEN received | Payment status | Notes / next follow-up date`

### Follow-up cadence

- **Day 0:** DM (short template above)
- **Day 3:** Follow-up in same thread — add 1 new proof point (screenshot of the avatar video feature)
- **Day 7:** Switch channel (DM → email in bio, or comment on latest post)
- **Day 14:** Final "no worries" touch + leave the free Pro code anyway (seeds future organic mentions)
- Then mark Closed–Lost, revisit in 90 days with traction stats ("we've had 6K signups since we last talked")
- **Post-deal:** brief within 48h of signing; content draft check within 7 days (concept-level notes only — don't script them); post goes live; pay within 7 days of posting (fast payment = referrals to other creators)
...
### Whitelisting for ads (the scale lever)

1. After 7 days, rank all live posts by installs-per-1K-views.
2. For the top ~20%, exercise the whitelisting option: TikTok → request Spark Ads auth code (60-day); Meta → Partnership Ads via Business Manager access.
3. Run the creator-handle version against your brand-account version; creator-handle ads typically win on CPA.
4. Renew or let expire based on CPA; track expiry dates in the sheet — running ads past the rights window is the #1 legal foot-gun.
5. Feed learnings back: the hooks that win as ads become the brief for the next creator wave.

### Weekly ops rhythm

- **Mon:** pipeline review (10 new creators added to sheet, 10 first-touches sent)
- **Wed:** follow-ups due today + content approvals
- **Fri:** performance pull (views/installs per live post), decide whitelisting exercises, pay invoices

---

*Sources: Feedspot Top 90 Career TikTok Influencers (2026), Welcome to the Jungle "10 CareerTok creators," Wonsulting creator roundup, Extern "18 influencers" list, Favikon HR/LinkedIn Top Voices, Fortune (Nav Karmacharya profile), Influencer Marketing Hub / Launchpoint / Influee 2025–26 rate guides, Conbersa & The Cirqle whitelisting guides. All follower counts approximate as of July 2026.*
