// Resend — transactional email sending for outreach + account emails.
...
export function resendFrom() {
  return process.env.RESEND_FROM || "Prowl <onboarding@resend.dev>";
}
...
// domain, e.g. "Prowl <hello@prowl.com>".
